...
function Login({notice=""}){
  ...
  return <div className="auth-page"><div className="auth-card">
    <div className="auth-brand"><div className="auth-mark"><img className="app-logo-img" src={`${import.meta.env.BASE_URL||"./"}mpr-icon-192.png`} alt="MPR"/></div><div><h1>MVR Smart Maintenance</h1><small>MAINTENANCE MANAGEMENT SYSTEM</small></div></div>
...
function AdminSidebar({route,profile,go,logout,open,onClose}){
  ...
  return <>
    ...
    <aside className={`admin-sidebar ${open?"open":""}`}>
      <div className="admin-side-brand"><button onClick={()=>{go("home");onClose?.()}}><span className="brand-mark"><img className="app-logo-img" src={`${import.meta.env.BASE_URL||"./"}mpr-icon-192.png`} alt="MPR"/></span><span><b>MVR Smart</b><small>MAINTENANCE</small></span></button></div>
