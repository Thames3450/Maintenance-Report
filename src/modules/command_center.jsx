...
export default function CommandCenter({profile,go}){
  ...
  return <div className="stack command-center-root executive-command-center">
    ...
    <div className="cc-layout executive-main-layout">
      ...
      <section className="cc-panel executive-panel"><div className="cc-panel-head"><div><span className="cc-eyebrow">TOP LOSS</span><h2>เครื่องที่เสียเวลาสูงสุดเดือนนี้</h2><p>จัดอันดับจาก Loss Time และจำนวน Breakdown</p></div></div>
